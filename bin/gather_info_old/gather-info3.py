...
def main():
    ...
    np.savetxt(os.path.join("gathered", "properties.txt"), fdata_arr,
               fmt="%7i %11.3f %11.6f % 14.6f % 14.6f % 11.6f % 14.6f % 14.6f",
               header="%5s %11s %11s %14s %14s %11s %14s %14s" % (
               "Frame", "Time(fs)", "S-squared", "Temperature", "Potential", "Kinetic", "Electron-KE", "Total-Energy"))
