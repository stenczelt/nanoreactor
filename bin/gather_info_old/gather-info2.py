...
import numpy as np
from numpy import abs, argsort, array, linalg, sqrt
        ...
        if mode == 0:
            ...
            if atomn == natoms:
                ...
                while stepnx > len(Coordinates):
                    print("\rHmm, we're exceeding the energy array size by %i, appending it (This could be Bad)" % (
                            stepnx - len(Coordinates)))
