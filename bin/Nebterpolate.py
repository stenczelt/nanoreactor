...
from nebterpolator.path_operations import equal_velocity, smooth_cartesian, smooth_internal
...
parser.add_argument('--window', type=str, default='hanning',
                    help='Type of window for smoothing: choose flat, hanning, hamming, bartlett, blackman')
...
while True:
    smoothed, errors = try_smooth_internal(xyzlist, atom_names, width=smoothing_width, bond_width=smoothing_width,
                                           angle_width=smoothing_width,
                                           dihedral_width=smoothing_width, allpairs=args.allpairs, w_morse=args.morse,
                                           rep=args.repulsive,
    ...
    if errors[-1] > 1e-3:
        ...
        smoothed_, errors_ = try_smooth_internal(xyzlist[::-1], atom_names, width=smoothing_width,
                                                 ...
                                                 w_morse=args.morse, rep=args.repulsive,
